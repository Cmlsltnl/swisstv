                        <div id="header_bloc_right">
                            <a href="#" onclick="xajax_next_month_process('<?php echo $month ?>','<?php echo $year ?>','<?php echo game::PREVIOUS_MONTH ?>','<?php echo game::CATEGORY_FRIENDS ?>','<?php echo game::CATEGORY_FRIENDS ?>')"><div class="button_left"></div></a>
                            ...
                            <a href="#" onclick="xajax_next_month_process('<?php echo $month ?>','<?php echo $year ?>','<?php echo game::NEXT_MONTH ?>','<?php echo game::CATEGORY_FRIENDS?>','<?php echo game::CATEGORY_FRIENDS ?>')"><div class="button_right"></div></a>
                        </div>
