                        <div id="header_bloc_left">
                            <a href="#" onclick="xajax_next_week_process('<?php echo $week ?>','<?php echo $year ?>','<?php echo game::PREVIOUS_WEEK ?>','<?php echo game::CATEGORY_ME ?>')"><div class="button_left"></div></a>
                            <div id="top_week"><?php echo $this->lang->line('classement_top_week');echo $week; ?></div>
                            <a href="#" onclick="xajax_next_week_process('<?php echo $week ?>','<?php echo $year ?>','<?php echo game::NEXT_WEEK ?>','<?php echo game::CATEGORY_ME ?>')"><div class="button_right"></div></a>
                        </div>
